...
final class OrdersDetailViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.orderQty.text = String(self.orderQuantity[(indexPath as NSIndexPath).row])
        cell.orderName.text = self.orderName[(indexPath as NSIndexPath).row]
        cell.orderPrice.text = formatter.stringFromNumber(self.orderPrice[(indexPath as NSIndexPath).row] * Double(self.orderQuantity[(indexPath as NSIndexPath).row]))
